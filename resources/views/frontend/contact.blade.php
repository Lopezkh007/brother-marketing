...
@section('content')
    <main class="main__content_wrapper">
                ...
                <div class="row row-cols-1">
                    <div class="col">
                        <!-- <div class="breadcrumb__content text-center">
                            <h1 class="breadcrumb__content--title">Contact Us</h1>
        ...
        <section class="contact__section section--padding">
            <div class="container">
                <div class="contact__section--heading text-center mb-40">
                    ...
                    <p class="contact__section--heading__desc">We Would Like To Hear From You Anytime</p>
                </div>
                        ...
                        <div class="contact__info--items">
                            ...
                            <div class="contact__info--items__inner d-flex">
                                ...
                                <div class="contact__info--content">
                                    <p class="contact__info--content__desc text-white">Please call me by <br> 
                                        <a href="tel:+855{{$contact->telephone1}}">{{$contact->telephone1}} / </a> 
                                        <a href="tel:+855{{$contact->telephone2}}">{{$contact->telephone2}}</a>   
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="contact__info--items__inner d-flex">
                                ...
                                <div class="contact__info--content">
                                    <p class="contact__info--content__desc text-white"> 
                                        <a href="mailto:info@brother-marketing.com">
                                            {{$contact->email1}}
                                        </a> <br> 
                                        <a href="mailto:sokleng@brother-marketing.com">
                                            {{$contact->email2}}
                                        </a>
                                    </p> 
                                </div>
                        ...
                        <div class="contact__info--items">
                            ...
                            <ul class="contact__info--social d-flex">
                                <li class="contact__info--social__list">
                                    <a class="contact__info--social__icon" target="_blank" href="{{asset($contact->facebook)}}">
        ...
        <div class="contact__map--area section--padding pt-0">
            <iframe class="contact__map--iframe" src="https://www.google.com/maps/embed/v1/place?q={{$contact->map_embed_link}}&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
        </div>
            ...
            <div class="container">
                <div class="brand__section--inner d-flex justify-content-between align-items-center">
                    @foreach ($partners as $partner)
                        ...
                        <img class="brang__logo--img" src="{{asset('uploads/partners/'.$partner->image)}}" alt="{{$partner->name}}">
                    </div>
                    @endforeach
                </div>
            </div>
