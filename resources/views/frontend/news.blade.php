...
@section('content')
    ...
    <main class="main__content_wrapper">
        ...
        <section class="breadcrumb__section breadcrumb__bg6" style="background-image: url('{{asset('uploads/banners/'.$banners->image)}}')">
            <div class="container">
        ...
        <section class="blog__section section--padding">
            <div class="container">
                <div class="section__heading border-bottom mb-30">
                    <h2 class="section__heading--maintitle">LASTEST NEWS</h2>
                </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 mb-30">
                                <div class="blog__card">
                                    <div class="blog__card--thumbnail">
                                        ...
                                        href="{{route('blogdetail',$item->id)}}">
                                            <img class="blog__card--thumbnail__img" 
                                            src="{{asset('uploads/blogs/'.$item->thumbnail)}}" alt="blog-img">
                                        </a>
                                    ...
                                    <div class="blog__card--content">
                                        ...
                                        <div class="blog__card--footer d-flex justify-content-between align-items-center">
                                            <a class="blog__card--btn__link" 
                                            href="{{route('blogdetail',$item->id)}}">Read more 
