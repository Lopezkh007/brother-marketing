...
@section('content')
    ...
    <main class="main__content_wrapper">
        ...
        <section class="breadcrumb__section breadcrumb__bg6">
            <div class="container">
                ...
                <div class="blog__section--inner">
                    <div class="row mb--n30">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 mb-30">
                            <div class="blog__card">
                                <div class="blog__card--thumbnail">
                                    <a class="blog__card--thumbnail__link" href="{{url('blogDetail')}}"><img class="blog__card--thumbnail__img" src="{{url('assets/img/blog/blog1.webp')}}" alt="blog-img"></a>
