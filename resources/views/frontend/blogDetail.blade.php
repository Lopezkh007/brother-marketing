                        ...
                        <div class="blog__details--wrapper">
                            <div class="entry__blog">
                                <div class="blog__post--header mb-30">
                                    <h2 class="post__header--title mb-15">
                                        @if (config('app.locale')=='kh')
                                            {{$new->title->kh?$new->title->kh:$new->title->en}}
                                        @else
                                            {{$new->title->en}}
                                        @endif
                                    </h2>
                                ...
                                <div class="blog__thumbnail mb-30">
                                    ...
                                    src="{{asset('uploads/blogs/'.$new->thumbnail)}}" alt="blog-img" width="100%">
                                </div>
                                <div class="blog__details--content">
                                    <h3 class="blog__details--content__subtitle mb-25">
                                        @if (config('app.locale')=='kh')
                                            {{$new->summary->kh?$new->summary->kh:$new->summary->en}}
                                        @else
                                            {{$new->summary->en}}
                                        @endif
                                    </h3>
                                    <p class="blog__details--content__desc mb-20">
                                        @if (config('app.locale')=='kh')
                                            {{$new->description->kh?$new->description->kh:$new->description->en}}
                                        @else
                                            {{$new->description->en}}
                                        @endif
                                    </p>
                                    ...
                                    @foreach ($categories as $item)
                                        <li class="widget__categories--menu__list">
                                            <label class="widget__categories--menu__label d-flex align-items-center">
                                                ...
                                                src="{{asset('uploads/category-icon/'.$item->icon)}}" alt="categories-img">
