                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            ...
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox" href="{{asset('assets/img/product/big-product/product6.webp')}}" data-gallery="product-media-preview">
                                                    <svg class="product__items--action__btn--svg" xmlns="http://www.w3.org/2000/svg" width="22.51" height="22.443" viewBox="0 0 512 512"><path d="M221.09 64a157.09 157.09 0 10157.09 157.09A157.1 157.1 0 00221.09 64z" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32"></path><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="32" d="M338.29 338.29L448 448"></path></svg>
                                                    <span class="visually-hidden">product view</span> 
                                                </a>
                                            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="{{asset('assets/img/product/big-product/product3.webp')}}"><img class="product__media--preview__items--img" src="{{asset('assets/img/product/big-product/product6.webp')}}" alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox" href="{{asset('assets/img/product/big-product/product6.webp')}}" data-gallery="product-media-preview">
                                                    <svg class="product__items--action__btn--svg" xmlns="http://www.w3.org/2000/svg" width="22.51" height="22.443" viewBox="0 0 512 512"><path d="M221.09 64a157.09 157.09 0 10157.09 157.09A157.1 157.1 0 00221.09 64z" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32"></path><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="32" d="M338.29 338.29L448 448"></path></svg>
                                                    <span class="visually-hidden">product view</span> 
                                        ...
                                        <fieldset class="variant__input--fieldset">
                                            ...
                                            <ul class="variant__size d-flex">
                                                <li class="variant__size--list">
                                                    ...
                                                    <label class="variant__size--value red" for="weight4">0.8L</label>
                                                </li>
                                                <li class="variant__size--list">
                                                    <input id="weight5" name="weight" type="radio">
                                                    <label class="variant__size--value red" for="weight5">1.5L</label>
                                                </li>
                                                <li class="variant__size--list">
                                                    <input id="weight6" name="weight" type="radio">
                                                    <label class="variant__size--value red" for="weight6">5L</label>
                                                </li>
                                            </ul>
                                        </fieldset>
                                    </div>
                                        ...
                                        <div class="product__tab--content__step">
                                            <ul class="additional__info_list">
                                                <li class="additional__info_list--item">
                                                    ...
                                                    <span  class="info__list--item-content">1L &nbsp;&nbsp; 2L &nbsp;&nbsp; 5L &nbsp;&nbsp; 8L</span>
                                                </li>
                                                <li class="additional__info_list--item">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <article class="product__card">
                                <div class="product__card--thumbnail">
                                    <a class="product__card--thumbnail__link display-block" href="{{url('productDetail')}}">
                                ...
                                <div class="product__card--content">
                                    <h3 class="product__card--title"><a href="{{url('productDetail')}}">Amazon Cloud Cam Security
                                        Camera </a></h3>
                                    ...
                                    <div class="product__card--footer">
                                        <a class="product__card--btn primary__btn" href="{{url('productDetail')}}">
                                            View Detail
                                        </a>
                                    </div>   
                                </div>
                        ...
                        <div class="swiper-slide">
                            <article class="product__card">
                                ...
                                <div class="product__card--content">
                                    <h3 class="product__card--title"><a href="{{url('productDetail')}}">Lorem ipsum dolor, sit amet adipisi elit. </a></h3>
                                    <div class="product__card--price">
                        ...
                        <div class="swiper-slide">
                            <article class="product__card">
                                ...
                                <div class="product__card--content">
                                    <h3 class="product__card--title"><a href="{{url('productDetail')}}">Taboriosam aenda et itaque expcabo.</a></h3>
                                    <div class="product__card--price">
                        ...
                        <div class="swiper-slide">
                            <article class="product__card">
                                ...
                                <div class="product__card--content">
                                    <h3 class="product__card--title"><a href="{{url('productDetail')}}">Eius doloribus dicta labore magni nulla! </a></h3>
                                    <div class="product__card--price">
