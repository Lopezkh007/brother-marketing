            ...
            <div class="card mt-50">
                <div class="card-header align-items-center d-flex">
                    <div class="flex-grow-1 oveflow-hidden">
                        <p class="text-truncates mb-0" style="font-size: 1rem; font-weight: 600;">Create Slider</p>
                    </div>
                ...
                <div class="card-body pb-4 px-4">
                    ...
                    @endif
                    <form action="{{route('slider.create')}}" method="POST" class="row needs-validation" novalidate>
                        @csrf
                        <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 mb-3">
                                            ...
                                            <input name="subtitle[kh]" type="text" class="form-control" 
                                                    placeholder="Enter subtitle in Khmer" />
                                        </div>
                                        <div class="col-lg-12 mb-3">
                                            <label for="des" class="form-label">Description</label>
                                        ...
                                        <div class="col-lg-12 mb-3">
                                            ...
                                            <input name="label[kh]" type="text" class="form-control" 
                                               placeholder="Enter label in Khmer" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-text">
                                            <div class="form-check">
                                                <input class="form-check-input" name="redirect_new_tap" type="checkbox" value="1" id="flexCheckDefault">
