...
@section('content')
    @include('admin.layouts.page_title', ['pageTitle'=>'Services'])
            ...
            <div class="card mt-50 py-4 px-3">
                <div class="row">
                    <div class="col-lg-12" id="table__gridjs--container">
                        <a class="btn btn-primary table__gridjs--create" href="{{route('service.form')}}">
...
@section('script-template')
    ...
    <script src="{{asset('backend-assets/js/pages/service.init.js')}}"></script>
@endsection