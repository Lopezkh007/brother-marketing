...
@section('content')
    @include('admin.layouts.page_title', ['pageTitle'=>'Service'])
        ...
        <div class="col-12">
            <div class="card mt-50">
                ...
                <div class="card-body pb-4 px-4">
                    ...
                    @endif
                    <form action="{{route('service.create')}}" method="POST" class="row needs-validation" novalidate>
                        @csrf
                        <div class="row">
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                ...
                                <div class="tab-content mb-3">
                                    ...
                                    <div class="tab-pane" id="summaryKhmer" role="tabpanel">
                                        <input 
                                            name="summary[kh]" type="text" 
                                            class="form-control"
                                            placeholder="Enter summary in Khmer" 
                                        />
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane active" id="english" role="tabpanel">
                                                <textarea name="description[en]" 
                                                    ...
                                                    cols="30" rows="5" placeholder="Enter description"
                                                ></textarea>
                                            </div>
                                            <div class="tab-pane" id="khmer" role="tabpanel">
...
@section('script-template')
    ...
    <script>
        ...
        FilePond.setOptions({
            server: {
                url: "/admin/file-upload/image/service",
                headers: {
