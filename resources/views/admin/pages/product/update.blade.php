        ...
        <div class="col-12">
            <div class="card mt-50">
                ...
                <div class="card-body pb-4 px-4">
                    ...
                    @endif
                    <form action="{{route('product.update', $model->id)}}" method="POST" class="row needs-validation" novalidate enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        <div class="row">
                            <div class="col-8">
                                <div class="row">
                                        ...
                                        <div class="tab-content mb-3">
                                            <div class="tab-pane active" id="desEnglish" role="tabpanel">
                                                <textarea name="des[en]" class="form-control ckeditor-classic1" cols="30" rows="5" 
                                                          placeholder="Enter description in English">{!!$model->des->en!!}</textarea>
                                            </div>
                                            <div class="tab-pane" id="desKhmer" role="tabpanel">
                                                <textarea name="des[kh]" class="form-control ckeditor-classic1" cols="30" rows="5" 
                                                          placeholder="Enter description in Khmer">{!!$model->des->kh!!}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12 mt-2">
                                        ...
                                        <div class="tab-content mb-3">
                                            <div class="tab-pane active" id="additionalInfoEnglish" role="tabpanel">
                                                <textarea name="additionalInfo[en]" class="form-control ckeditor-classic" cols="30" rows="5" 
                                                          placeholder="Enter additional info in English">{!!$model->additional_info->en!!}</textarea>
                                            </div>
                                            <div class="tab-pane" id="additionalInfoKhmer" role="tabpanel">
                                                <textarea name="additionalInfo[kh]" class="form-control ckeditor-classic" cols="30" rows="5" 
                                                          placeholder="Enter additional info in Khmer">{!!$model->additional_info->kh!!}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12 mt-2">
                                        ...
                                        <div class="w-100">
                                            ...
                                            <div class="card mt-2" style="width: 150px;">
                                                @if($model->image)
                                                    <img src="{{asset('uploads/products/'.$model->image)}}" alt="" id="main_image_prev" 
                                    ...
                                    <div class="col-md-12 mt-2">
                                        ...
                                        <div class="w-100">
                                            ...
                                            <input type="hidden" name="image_back_tmp" value="{{$model->image_back}}" />
                                            <div class="card mt-2" style="width: 150px;">
                                                @if($model->image)
                                                    <img src="{{asset('uploads/products/'.$model->image_back)}}" alt="" id="back_view_image_prev" 
                                                         class="img-fluid" style="height: 150px; object-fit: cover;">
                                                @else
                                    ...
                                    <div class="col-md-12 mt-2">
                                        ...
                                        <div class="w-100">
                                            ...
                                            <input type="hidden" name="galleries_tmp" value="{{json_encode($model->galleries)}}">
                                            <div id="galleries_prev" class="row gap-1 mt-3">
                                                @foreach($model->galleries as $gallery)
                                                <img class="col-6 col-md-3" src="{{asset('uploads/products/'.$gallery)}}" alt="" 
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="tab-content mb-3">
                                            <div class="tab-pane active" id="productNameEnglish" role="tabpanel">
                                                <input type="text" class="form-control" name="name[en]" placeholder="Enter name in English" value="{{$model->name->en}}">
                                            </div>
                                            <div class="tab-pane" id="productNameKhmer" role="tabpanel">
                                                <input type="text" class="form-control" name="name[kh]" placeholder="Enter name in Khmer" value="{{$model->name->kh}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="mb-3">
                                            ...
                                            <input name="code" type="text" class="form-control" id="code" placeholder="Enter product code" value="{{$model->code}}" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" step="0.0001" class="form-control" id="priceInput" name="price" placeholder="Enter price" value="{{$model->price}}" >
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="discountInput" class="form-label">Discount(%)</label>
                                            <input type="number" step="0.0001" class="form-control" id="discountInput" name="discount" placeholder="Enter discount" value="{{$model->discount}}">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" data-choices name="brand_id" id="brandSelect">
                                                ...
                                                @foreach ($brands as $item)
                                                    <option value="{{$item->id}}" @if($item->id == $model->brand_id) selected @endif>{{json_decode($item->title)->en}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" data-choices name="category_id" id="categorySelect">
                                                ...
                                                @foreach ($categories as $item)
                                                    <option value="{{$item->id}}" @if($item->id == $model->category_id) selected @endif>{{json_decode($item->title)->en}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" data-choices data-choices-removeItem name="capacity" value="{{$model->capacity}}" >
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <label for="type" class="form-label">Type</label>
                                            <input type="text" data-choices data-choices-removeItem name="type" value="{{$model->type}}" >
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="mb-3">
                                            <label for="ordering" class="form-label">Ordering Number</label>
                                            <input name="ordering" type="number" class="form-control" id="ordering" placeholder="Enter number" value="{{$model->ordering}}" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="status-select" name="status">
                                                ...
                                                <option value="0" @if($model->status == 0) selected @endif>Disable</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 mt-2">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="is_new" 
                                                   name="is_new" value="1" @if($model->is_new == 1) checked @endif>
                                    ...
                                    <div class="col-md-12 mt-2">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="is_feature" 
                                                   name="is_feature" value="1" @if($model->is_feature == 1) checked @endif>
                                    ...
                                    <div class="col-md-12 mt-2">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="is_hot" name="is_hot" value="1" @if($model->is_hot == 1) checked @endif>
