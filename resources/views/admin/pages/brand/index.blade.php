            ...
            <div class="card mt-50 py-4 px-3">
                <div class="row">
                    <div class="col-lg-12" id="table__gridjs--container">
                        <a class="btn btn-primary table__gridjs--create" href="{{route('brand.form')}}">
                            <i class="ri-add-fill me-1 align-bottom"></i> Create Brand
                        </a>
...
@section('script-template')
    ...
    <script src="{{asset('backend-assets/js/pages/brand.init.js')}}"></script>
@endsection