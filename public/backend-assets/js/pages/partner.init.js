const mainUrl = `${window.location.protocol}//${window.location.host}/admin/partner`;
const deleteAlertDialog = "Are you sure to delete this partner?";
        ...
        columns: [
            ...
            },
            {
                ...
                formatter: function (name) {
                    return gridjs.html(`<span>${name}</span>`);
                },
            },
            "Link To",
            "Status",
