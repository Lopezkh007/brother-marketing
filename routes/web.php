...
Route::get("blogDetail/{id}",[BlogDetailController::class, 'index'])->name("blogdetail");
Route::get("serviceDetail/{id}",[ServiceDetailController::class, 'index'])->name("servicedetail");
